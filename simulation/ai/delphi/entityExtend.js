...
{
	return ent.hasClass("Siege") === true;
};
...
m.getMaxStrength = function(ent, againstClass)
{
	...
	for (let type of attackTypes)
	{
		...
		for (let str in attackStrength)
		{
			...
			case "Pierce":
				...
				break;
			default:
				API3.warn("Delphi: " + str + " unknown attackStrength in getMaxStrength");
			}
		}
	...
	for (let str in armourStrength)
	{
		...
		case "Pierce":
			...
			break;
		default:
			API3.warn("Delphi: " + str + " unknown armourStrength in getMaxStrength");
		}
	}
