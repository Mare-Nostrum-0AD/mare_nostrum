...
Player.prototype.Init = function()
{
	...
	let resCodesTrade = Resources.GetCodes((res) => res.tradeable);
	let quotient = Math.floor(20 / resCodesTrade.length);
	let remainder = 20 % resCodesTrade.length;
	...
	for (let i in resCodesTrade) {
		let res = resCodesTrade[i];
...
{
	let resCodes = Resources.GetCodes((res) => res.tradeable);
	let sumProba = 0;
