...
In the City Phase, most factions can further augment their cities' growth rates by building Monuments – amenities such as theaters and bathhouses that attract more people to city life. These provide a massive boost both to the city's base growth rate and the trade growth rate. These becomes almost a necessity to bring your City's population up to the 25,000 needed to become a Metropolis.

## New Resources
In addition to the four basic resources in Empires Ascendant, Mare Nostrum adds Wealth and Manpower.

Wealth is required to build temples, monuments, and wonders, as well as to train healers, mercenaries, and champion units.
...
As your civil centers grow, so too do their manpower production rates; typically, a civil center's manpower production rate will increase by one for every 1,000 additional citizens.
...
- Female Citizens have been replaced by a mixed-gender Citizen class, which have more or less the same stats as female citizens.
...
## Installation
To install the development version of this mod, clone this repository into your 0AD mod directory (on Linux and MacOS, it should be ~/.local/share/0ad/mods/). If you don't intend on contributing to this project, I recommend a shallow clone.
```shell
git clone --depth=1 https://github.com/Mare-Nostrum-0AD/mare_nostrum ~/.local/share/0ad/mods/mare_nostrum
```

Stable versions will be available on [mod.io](https://0ad.mod.io). They should be released shortly after new releases of 0AD: Empires Ascendant.
