...
for (let i = 0; i < numPlayers; ++i)
{
	...
	placePlayerBase({
		...
		"Pasture": {
			"template": localBiome.gaia.flora.pasture,
			"minCount": 4,
			"maxCount": 8
		},
		"Mines": {
...
createFood(
	[
		...
		[new SimpleObject(biomes.highlands.gaia.flora.pasture, 5, 7, 0, 4)]
	],
	[
		scaleByMapSize(2, 16),
		scaleByMapSize(2, 12),
	...
	[
		avoidClasses(clForest, 0, clPlayer, 20, clCliffs, 2, clWater, 2, clRock, 4, clMetal, 4, clDock, 6),
		constraintHighlands
	],
	clFood);
...
createFood(
	[
		...
		[new SimpleObject(biomes.lowlands.gaia.flora.pasture, 5, 7, 0, 4)]
	],
	[
		scaleByMapSize(2, 16),
		scaleByMapSize(2, 12),
