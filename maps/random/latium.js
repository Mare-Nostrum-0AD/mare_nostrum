...
const oPasture = "gaia/flora_pasture";
...
group = new SimpleGroup([new SimpleObject(oPasture, 5,7, 0,3)], true, clFood);
createObjectGroupsDeprecated(group, 0,
	avoidClasses(clWater, 5, clForest, 2, clCliff, 1, clPlayer, 5, clMetal, 6, clRock, 6, clFood, 8),
	2.0 * numPlayers, 100
);
