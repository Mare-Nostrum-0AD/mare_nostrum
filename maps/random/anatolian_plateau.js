...
placePlayerBases({
	...
	"Berries": {
		// should use pasture instead of berry bushes
		"template": oPasture
	},
	"Mines": {
		"types": [
...
createObjectGroupsDeprecated(group, 0,
	...
	randIntInclusive(1, 2) * numPlayers + 1, 50
);

g_Map.log("Creating pastures");
group = new SimpleGroup(
	[new SimpleObject(oPasture, 5,7, 0,4)],
	true, clFood
);
createObjectGroupsDeprecated(group, 0,
	avoidClasses(clForest, 0, clPlayer, 20, clHill, 1, clFood, 20),
	randIntInclusive(3, 6) * numPlayers + 2, 50
);
